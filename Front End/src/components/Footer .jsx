        ...
        <footer className="bg-[#38bdf8]">
            <div className="mx-auto max-w-7xl py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                <nav className="-mx-5 -my-2 flex flex-wrap justify-center order-2" aria-label="Footer">
                    <div className="px-5">
                        <a href="#" className="text-base text-[#0f172a] hover:text-gray-200">Terms of Service</a>
                    </div>

                    <div className="px-5">
                        <a href="#" className="text-base text-[#0f172a] hover:text-gray-200">Privacy Policy</a>
                    </div>
                </nav>
                <div className="mt-8 md:mb-8 flex justify-center space-x-6 md:order-3">
                    <a href="#" className="text-[#0f172a] hover:text-gray-200">
                ...
                <div className="mt-8  md:order-1 md:mt-0 ">
                    <p className="text-center text-base text-[#0f172a]">
